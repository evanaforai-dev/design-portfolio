 ...
 * empty slots. Six square projects tile a 3-column grid exactly, so the grid is
 * a gap-free rectangle at every breakpoint:
 *   lg  3 cols × 2 rows
 *   sm  2 cols × 3 rows
 *   base 1 col × 6 rows (a stack)
 *
...
// full — six projects fill a clean 3-column rectangle.
const LAYOUT: string[] = [
  "airtribe-learn",
